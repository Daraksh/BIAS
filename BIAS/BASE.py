...
from torch.utils.tensorboard import SummaryWriter
# get model
#from Models.got_losses_ortho_densenet import Network , Supervised_Contrastive_Loss
...
def custom_load(
        ...
        label='No Finding',
        dataset_name='mimic',
        image_dir='/home/server6000/DATA2/DATA1/physionet.org/files/mimic-cxr-jpg/2.1.0/',
...
if __name__ == '__main__':
    ...
    #checkpoint_path=sys.argv[5]#changed
    domain = 0 #changed
    ...
    if dev_mode == "dev":
        ...
        #df = pd.read_csv('/home/darakshan/Documents/physionet.org/xray_training_dataset_patch.csv').sample(100)
       ...
       # df = pd.read_csv('/home/darakshan/Documents/physionet.org/xray_training_dataset_patch.csv')
         df = pd.read_csv('/home/server6000/DATA2/DATA1/physionet.org/xray_training_dataset_patch_AP.csv')
    ...
    for holdout_set in [domain]: 
        ...
        for indexer, label in enumerate([level]):
            ...
            optimizer_ft = optim.Adam(model_ft.parameters(), 0.0005)
